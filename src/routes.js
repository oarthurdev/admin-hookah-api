...
routes.post('/api/auth/logout', UserController.logout)
routes.post('/api/user/profile', UserController.verifyJWT, UserController.profile)
routes.post('/api/user/get-photo', UserController.verifyJWT, GeralController.getPhoto)
routes.post('/api/user/get-role', UserController.verifyJWT, GeralController.getRole)
...
routes.post('/api/lounge/get-all', UserController.verifyJWT, LoungeController.getAll)
